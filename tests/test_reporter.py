...
from puby.matcher import MatchResult, PotentialMatch
...
class TestConsoleReporter:
    ...
    def test_report_potential_matches_with_data(self, mock_echo):
        ...
        matches = [
            (self.test_publications[0], self.test_publications[1], 0.75)
        ]
...
class TestAnalysisReporter:
    ...
    def setup_method(self):
        ...
        self.test_result = AnalysisResult(
            missing_publications=[
                Publication("Missing Pub", [Author("Test Author")])
            ],
            duplicate_groups=[
                [
    ...
    def test_generate_sync_recommendations(self):
        """Test sync recommendation generation."""
        recommendations = self.reporter.generate_sync_recommendations(
            self.test_result
        )
